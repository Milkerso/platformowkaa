...
using GameShooter.Models;
using GameShooter;
using Microsoft.Xna.Framework.Input;

namespace GameShooter.Sprites
{
    public class Player : Ship
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            Position = Vector2.Clamp(Position, new Vector2(80, 0), new Vector2(global::Game1.ScreenWidth / 4, global::Game1.ScreenHeight));
        }
