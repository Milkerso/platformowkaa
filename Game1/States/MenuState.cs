...
using GameShooter.Sprites;
using GameShooter.Controls;
...
namespace GameShooter.States
{
    public class MenuState : State
    {
        ...
        public MenuState(global::Game1 game, ContentManager content)
          : base(game, content)
        {
        }
            ...
            _components = new List<Component>()
      {
        ...
        {
          Layer = 0f,
          Position = new Vector2(global::Game1.ScreenWidth / 2, global::Game1.ScreenHeight / 2),
        },
        new Button(buttonTexture, buttonFont)
        {
          Text = "1 Player",
          Position = new Vector2(global::Game1.ScreenWidth / 2, 400),
        ...
        {
          Text = "2 Players",
          Position = new Vector2(global::Game1.ScreenWidth / 2, 440),
        ...
        {
          Text = "Highscores",
          Position = new Vector2(global::Game1.ScreenWidth / 2, 480),
        ...
        {
          Text = "Quit",
          Position = new Vector2(global::Game1.ScreenWidth / 2, 520),
